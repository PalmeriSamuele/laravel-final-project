                        ...
                        <div class="widget-info sidebar-product clearfix">
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html"><img src="img/blog/3.jpg" alt="" /></a>
                                </div>
                                <div class="product-info">
                                    <h4 class="post-title"><a href="#">Dummy Blog</a></h4>
                                    <span><strong><a class="text-gray" href="#">June 12, 2017</a></strong></span>
                                </div>
                            </div>
                            <!-- Single-product end -->
                            <!-- Single-product start -->
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html"><img src="img/blog/4.jpg" alt="" /></a>
                                </div>
                                <div class="product-info">
                                    <h4 class="post-title"><a href="#">Dummy Blog</a></h4>
                                    <span><strong><a class="text-gray" href="#">June 12, 2017</a></strong></span>
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html"><img src="img/blog/5.jpg" alt="" /></a>
                                </div>
                                <div class="product-info">
                                    <h4 class="post-title"><a href="#">Dummy Blog</a></h4>
                                    <span><strong><a class="text-gray" href="#">June 12, 2017</a></strong></span>
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html"><img src="img/blog/6.jpg" alt="" /></a>
                                </div>
                                <div class="product-info">
                                    <h4 class="post-title"><a href="#">Dummy Blog</a></h4>
                                    <span><strong><a class="text-gray" href="#">June 12, 2017</a></strong></span>
                    ...
                    <aside class="widget widget-comments mb-30">
                        ...
                        <div class="widget-info comments-filter clearfix">
                            <div class="single-recent-comments">
                                ...
                                <p>There are many variations of passag of Lorem Ipsum available...</p>
                            </div>
                            <div class="single-recent-comments">
